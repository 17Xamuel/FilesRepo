...
if (mysqli_num_rows($exe2) > 0) {
    ...
    if (strlen($fisrt_name) < 3 || strlen($last_name) < 3 || strlen($password) < 5 || strpos($email, '@') < 6 || strlen($phone) < 10) {
        ...
        $sql3 = "INSERT INTO users(first_name, last_name, password, email, phone, type, approval, user_image)
                VALUES ('$fisrt_name', '$last_name', '$password', '$email','$phone', '$type', '$approval' '$user_image')";
